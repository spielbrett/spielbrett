...
#ifndef GOOGLE_PROTOBUF_INCLUDED_proto_2finstance_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_proto_2finstance_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_proto_2finstance_2eproto
...
struct TableStruct_proto_2finstance_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2finstance_2eproto;
namespace instance {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::instance::CreateInstanceRequest* Arena::CreateMaybeMessage<::instance::CreateInstanceRequest>(Arena*);
template<> ::instance::CreateInstanceResponse* Arena::CreateMaybeMessage<::instance::CreateInstanceResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace instance {
...
class CreateInstanceRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:instance.CreateInstanceRequest) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "instance.CreateInstanceRequest";
  }
  protected:
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_proto_2finstance_2eproto;
};
// -------------------------------------------------------------------

class CreateInstanceResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:instance.CreateInstanceResponse) */ {
 public:
...
inline const std::string& CreateInstanceRequest::session_id() const {
  // @@protoc_insertion_point(field_get:instance.CreateInstanceRequest.session_id)
...
void CreateInstanceRequest::set_session_id(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.session_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:instance.CreateInstanceRequest.session_id)
}
inline std::string* CreateInstanceRequest::mutable_session_id() {
  std::string* _s = _internal_mutable_session_id();
  // @@protoc_insertion_point(field_mutable:instance.CreateInstanceRequest.session_id)
  return _s;
}
...
inline std::string* CreateInstanceRequest::release_session_id() {
  // @@protoc_insertion_point(field_release:instance.CreateInstanceRequest.session_id)
...
inline void CreateInstanceRequest::set_allocated_session_id(std::string* session_id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:instance.CreateInstanceRequest.session_id)
}
...
inline const std::string& CreateInstanceRequest::instance_type() const {
  // @@protoc_insertion_point(field_get:instance.CreateInstanceRequest.instance_type)
...
void CreateInstanceRequest::set_instance_type(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.instance_type_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:instance.CreateInstanceRequest.instance_type)
}
inline std::string* CreateInstanceRequest::mutable_instance_type() {
  std::string* _s = _internal_mutable_instance_type();
  // @@protoc_insertion_point(field_mutable:instance.CreateInstanceRequest.instance_type)
  return _s;
}
...
inline std::string* CreateInstanceRequest::release_instance_type() {
  // @@protoc_insertion_point(field_release:instance.CreateInstanceRequest.instance_type)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:instance.CreateInstanceRequest.instance_type)
}
...
inline const std::string& CreateInstanceResponse::instance_id() const {
  // @@protoc_insertion_point(field_get:instance.CreateInstanceResponse.instance_id)
...
void CreateInstanceResponse::set_instance_id(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.instance_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:instance.CreateInstanceResponse.instance_id)
}
inline std::string* CreateInstanceResponse::mutable_instance_id() {
  std::string* _s = _internal_mutable_instance_id();
  // @@protoc_insertion_point(field_mutable:instance.CreateInstanceResponse.instance_id)
  return _s;
}
...
inline std::string* CreateInstanceResponse::release_instance_id() {
  // @@protoc_insertion_point(field_release:instance.CreateInstanceResponse.instance_id)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:instance.CreateInstanceResponse.instance_id)
}
...
inline const std::string& CreateInstanceResponse::endpoint() const {
  // @@protoc_insertion_point(field_get:instance.CreateInstanceResponse.endpoint)
...
void CreateInstanceResponse::set_endpoint(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.endpoint_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:instance.CreateInstanceResponse.endpoint)
}
inline std::string* CreateInstanceResponse::mutable_endpoint() {
  std::string* _s = _internal_mutable_endpoint();
  // @@protoc_insertion_point(field_mutable:instance.CreateInstanceResponse.endpoint)
  return _s;
}
...
inline std::string* CreateInstanceResponse::release_endpoint() {
  // @@protoc_insertion_point(field_release:instance.CreateInstanceResponse.endpoint)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:instance.CreateInstanceResponse.endpoint)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_proto_2finstance_2eproto
