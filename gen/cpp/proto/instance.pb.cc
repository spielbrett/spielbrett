...
static ::_pb::Metadata file_level_metadata_proto_2finstance_2eproto[2];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_proto_2finstance_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_proto_2finstance_2eproto = nullptr;

const uint32_t TableStruct_proto_2finstance_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::instance::CreateInstanceRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::instance::CreateInstanceRequest, _impl_.session_id_),
  PROTOBUF_FIELD_OFFSET(::instance::CreateInstanceRequest, _impl_.instance_type_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::instance::CreateInstanceResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::instance::CreateInstanceResponse, _impl_.instance_id_),
  PROTOBUF_FIELD_OFFSET(::instance::CreateInstanceResponse, _impl_.endpoint_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::instance::CreateInstanceRequest)},
  { 8, -1, -1, sizeof(::instance::CreateInstanceResponse)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::instance::_CreateInstanceRequest_default_instance_._instance,
  &::instance::_CreateInstanceResponse_default_instance_._instance,
};

const char descriptor_table_protodef_proto_2finstance_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\024proto/instance.proto\022\010instance\"[\n\025Crea"
  "teInstanceRequest\022\035\n\nsession_id\030\001 \001(\tR\ts"
  "essionId\022#\n\rinstance_type\030\002 \001(\tR\014instanc"
  "eType\"U\n\026CreateInstanceResponse\022\037\n\013insta"
  "nce_id\030\001 \001(\tR\ninstanceId\022\032\n\010endpoint\030\002 \001"
  "(\tR\010endpoint2h\n\017InstanceService\022U\n\016Creat"
  "eInstance\022\037.instance.CreateInstanceReque"
  "st\032 .instance.CreateInstanceResponse\"\000B3"
  "Z1github.com/spielbrett/spielbrett-api/g"
  "en/go/protob\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_proto_2finstance_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_proto_2finstance_2eproto = {
    false, false, 379, descriptor_table_protodef_proto_2finstance_2eproto,
    "proto/instance.proto",
    &descriptor_table_proto_2finstance_2eproto_once, nullptr, 0, 2,
    schemas, file_default_instances, TableStruct_proto_2finstance_2eproto::offsets,
    file_level_metadata_proto_2finstance_2eproto, file_level_enum_descriptors_proto_2finstance_2eproto,
    file_level_service_descriptors_proto_2finstance_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_proto_2finstance_2eproto_getter() {
  return &descriptor_table_proto_2finstance_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_proto_2finstance_2eproto(&descriptor_table_proto_2finstance_2eproto);
namespace instance {
...
CreateInstanceRequest::CreateInstanceRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:instance.CreateInstanceRequest)
}
CreateInstanceRequest::CreateInstanceRequest(const CreateInstanceRequest& from)
  ...
  // @@protoc_insertion_point(copy_constructor:instance.CreateInstanceRequest)
}
...
CreateInstanceRequest::~CreateInstanceRequest() {
  // @@protoc_insertion_point(destructor:instance.CreateInstanceRequest)
...
// @@protoc_insertion_point(message_clear_start:instance.CreateInstanceRequest)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "instance.CreateInstanceRequest.session_id"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "instance.CreateInstanceRequest.instance_type"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* CreateInstanceRequest::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:instance.CreateInstanceRequest)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_session_id().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "instance.CreateInstanceRequest.session_id");
  ...
  if (!this->_internal_instance_type().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "instance.CreateInstanceRequest.instance_type");
    target = stream->WriteStringMaybeAliased(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:instance.CreateInstanceRequest)
  return target;
}

size_t CreateInstanceRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:instance.CreateInstanceRequest)
  size_t total_size = 0;
...
void CreateInstanceRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:instance.CreateInstanceRequest)
...
// @@protoc_insertion_point(class_specific_copy_from_start:instance.CreateInstanceRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata CreateInstanceRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_proto_2finstance_2eproto_getter, &descriptor_table_proto_2finstance_2eproto_once,
      file_level_metadata_proto_2finstance_2eproto[0]);
}
...
CreateInstanceResponse::CreateInstanceResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:instance.CreateInstanceResponse)
}
CreateInstanceResponse::CreateInstanceResponse(const CreateInstanceResponse& from)
  ...
  // @@protoc_insertion_point(copy_constructor:instance.CreateInstanceResponse)
}
...
CreateInstanceResponse::~CreateInstanceResponse() {
  // @@protoc_insertion_point(destructor:instance.CreateInstanceResponse)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:instance.CreateInstanceResponse)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "instance.CreateInstanceResponse.instance_id"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "instance.CreateInstanceResponse.endpoint"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* CreateInstanceResponse::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:instance.CreateInstanceResponse)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_instance_id().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "instance.CreateInstanceResponse.instance_id");
    target = stream->WriteStringMaybeAliased(
  ...
  if (!this->_internal_endpoint().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "instance.CreateInstanceResponse.endpoint");
    target = stream->WriteStringMaybeAliased(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:instance.CreateInstanceResponse)
  return target;
}

size_t CreateInstanceResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:instance.CreateInstanceResponse)
  size_t total_size = 0;
...
void CreateInstanceResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:instance.CreateInstanceResponse)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:instance.CreateInstanceResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata CreateInstanceResponse::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_proto_2finstance_2eproto_getter, &descriptor_table_proto_2finstance_2eproto_once,
      file_level_metadata_proto_2finstance_2eproto[1]);
}

// @@protoc_insertion_point(namespace_scope)
}  // namespace instance
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_NOINLINE ::instance::CreateInstanceRequest*
Arena::CreateMaybeMessage< ::instance::CreateInstanceRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::instance::CreateInstanceRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::instance::CreateInstanceResponse*
Arena::CreateMaybeMessage< ::instance::CreateInstanceResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::instance::CreateInstanceResponse >(arena);
}
