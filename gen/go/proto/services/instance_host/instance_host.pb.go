...
var file_proto_services_instance_host_instance_host_proto_goTypes = []interface{}{
...
func file_proto_services_instance_host_instance_host_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_services_instance_host_instance_host_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_services_instance_host_instance_host_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_services_instance_host_instance_host_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_services_instance_host_instance_host_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
