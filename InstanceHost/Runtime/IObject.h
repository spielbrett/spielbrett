...
public:
    ...
    virtual Board::Object::State observe(int playerIndex, bool perfectInformation) = 0;
    virtual std::string renderContents(int playerIndex, bool perfectInformation) = 0;
